...
- Fixing new artsum file parsing to account for multiple whitespace per line
...
- Bump to v0.5.0
- Removing artsum.toml as the artsum standard
...
- Bump to v0.4.1
- Updating multi-progress display logic to surface active workers at top of visible progress

## [0.4.0] - 2026-03-29

### Added

- Adding progress display and per-worker active artifact ux

### Changed

- Bump to v0.4.0
- Bumping dependencies to latest available versions
...
[0.5.1]: https://github.com/stephen-bunn/artsum/compare/v0.5.0..v0.5.1
[0.5.0]: https://github.com/stephen-bunn/artsum/compare/v0.4.1..v0.5.0
[0.4.1]: https://github.com/stephen-bunn/artsum/compare/v0.4.0..v0.4.1
[0.4.0]: https://github.com/stephen-bunn/artsum/compare/v0.3.0..v0.4.0
[0.3.0]: https://github.com/stephen-bunn/artsum/compare/v0.2.0..v0.3.0
